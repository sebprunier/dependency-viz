...
public class DependencyTreeHandler {
    ...
    public DependencyTreeHandler(@Context
    ServletContext ctx) {
        context = ctx;
        system = (RepositorySystem) context.getAttribute("repository-system");
    ...
    public Response versions(@Context
    Request request, @PathParam("groupId")
    String groupId, @PathParam("artifactId")
    String artifactId) {
        ...
        try {
            ...
            VersionRangeRequest arequest = new VersionRangeRequest(artifact, Lists.newArrayList(repositories), null);
    ...
    Request request, @PathParam("groupId")
    String groupId, @PathParam("artifactId")
    String artifactId, @PathParam("version")
    String version) {
        ...
        try {
            ArtifactRequest arequest = new ArtifactRequest(artifact, Lists.newArrayList(repositories), null);
        ...
        CollectRequest collectRequest = new CollectRequest(new Dependency(artifact, ""),
                Lists.newArrayList(repositories));
